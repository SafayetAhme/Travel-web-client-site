                    ...
                    <div>
                        <form>
                            ...
                            <div>
                                ...
                                <Link to="/payment">
                                    <div className="card-actions justify-end">
                                        <button className="btn w-full bg-[#12D1E5] border-[#12D1E5] text-white hover:bg-[#04e6ff] outline-none hover:border-[#04e6ff] shadow-lg shadow-cyan-500/50 ... ">Book Now</button>
                                    </div>
                                </Link>
                            </div>
                        </form>

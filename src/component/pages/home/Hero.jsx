...
const Hero = () => {
    return (
        <div>
            <div className="" style={{ backgroundImage: 'url(https://i.ibb.co/gwdmFrj/image-35-1.png)' }}>
                <div className="hero-overlay bg-opacity-60"></div>
                <div className="hero-content text-center text-neutral-content">
                    <div className="w-[700px] py-32">
                        <h1 className="mb-5 text-5xl font-bold">Find out where you can enjoy your next vacation</h1>

    ...
    return (
        <div>
            ...
            <div className="text-center">
                <button className="btn w-[200px] bg-[#12D1E5] border-[#12D1E5] text-white hover:bg-[#04e6ff] outline-none hover:border-[#04e6ff] shadow-lg shadow-cyan-500/50 ... ">Expolore More</button>
            </div>
        </div>
    );
};

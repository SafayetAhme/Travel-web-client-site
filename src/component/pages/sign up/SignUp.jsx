...
const SignUp = () => {
    ...
    return (
        <div className="grid py-20 px-12 gap-10 items-center md:grid-cols-2">
            <div>
                <img className="rounded-xl h-[750px]" src="https://i.pinimg.com/564x/bf/fa/be/bffabe013f26f27cae023e00a2c72213.jpg" alt="" />
            </div>
                            ...
                            <div className="relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white px-10 py-16 text-center dark:bg-dark-2 sm:px-12 md:px-[60px]">
                                ...
                                <form onSubmit={handlecreateUser}>
                                    ...
                                    <div className="form-control mt-6">
                                        <button className="w-full cursor-pointer rounded-md border bg-[#12D1E5] border-[#12D1E5] hover:border-[#04e6ff] shadow-lg shadow-cyan-500/50 hover:bg-[#04e6ff] px-5 py-3 text-base font-medium text-white transition hover:bg-opacity-90">Sign Up</button>
                                    </div>
                                </form>
                                {/*  */}
                                ...
                                <ul className="-mx-2 mb-12 flex justify-between">
                                    ...
                                    <div onClick={handleGoogleSignIn} className="w-full px-2">
                                        <li>
                                            <a
